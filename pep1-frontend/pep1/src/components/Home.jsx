  ...
  return (
      <div className="home-container">
        ...
        <div className="content-container">
          <h1 className="title">AutoFix: Cadena de talleres</h1>
          <div className="option-card">
            <p>
                ¡Bienvenido a AutoFix! Somos una cadena de talleres especializados en el mantenimiento y reparación de
                ...
                serios reclamos de los clientes.</p>
          </div>
        </div>
      </div>
  );
